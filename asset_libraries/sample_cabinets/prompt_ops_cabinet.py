...
class hb_closet_starters_OT_closet_door_prompts(bpy.types.Operator):
    bl_idname = "hb_closet_starters.closet_door_prompts"
...
classes = (
    ...
    hb_closet_starters_OT_closet_door_prompts,
)
